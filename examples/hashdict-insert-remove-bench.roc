...
insertHelper = \dict, remaining, loads ->
    if remaining <= 0 then
        ...
        (T nextDict insertLoads) = U64FlatHashDict.insert dict (Num.toU64 remaining) remaining
        insertHelper nextDict (remaining - 1) (loads + insertLoads)
